...
FARL_PRETRAIN_PATH = 'https://github.com/FacePerceiver/FaRL/releases/download/pretrained_weights/FaRL-Base-Patch16-LAIONFace20M-ep64.pth'
...
def load_farl(model_type, model_file) -> VisualTransformer:
    checkpoint = load_state_dict_from_url(model_file, map_location='cpu')
    if model_type == "base":
